...
'''
* this is a program to run Model with Ridge Regression for estimating a function
* run : python main.py <complexity> <training-points-file> <test-points-file> <lambhda> -1
...
#lambhda for Ridge Regression
lambhda = float(sys.argv[4])/100
...
if int(sys.argv[5]) == 0:
	...
	print str(numpy.log(lambhda))+" "+str(trainError)+" "+str(testError)
